// Same content as db/schema.sql, kept here as a plain string so the
// /api/admin/bootstrap route can apply it at runtime on Vercel without
// depending on filesystem access to non-imported files in the serverless bundle.
